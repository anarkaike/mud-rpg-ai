...
async def get_player_state(phone: str):
    ...
    return {
        "player": {
            ...
            "completed_challenges": int(meta.get("completed_challenges", 0)),
            "completed_missions": int(meta.get("completed_missions", 0)),
        },
        ...
        "social_matches": rooms.find_social_matches(player_phone, limit=8) or [],
        "social_match_history": rooms.list_social_match_history(player_phone, limit=8) or [],
        "current_room": room_info or {},
