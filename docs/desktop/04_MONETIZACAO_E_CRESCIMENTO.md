...
> _"Simples como uma semente que cresce organicamente"_ — O modelo de negócio precisa ser tão natural quanto o jogo.

**Princípios:**
- Nunca cobrar para jogar (free-to-play core)
- Monetizar **valor adicionado**, não acesso básico
- Receita flui naturalmente das interações, não de paywalls
- Empreendedores parceiros pagam por visibilidade contextualizada

---

## Modelos de Receita

### 1. 🏢 Parcerias com Empreendimentos (B2B)
...
> **Proposta de valor**: "Traga jogadores engajados para seu bar — eles vêm por missão, ficam pela experiência."

### 2. 💎 Itens/Experiências Premium (B2C)

| Item | Descrição | Modelo |
|------|-----------|--------|
| **Cartas especiais** | Cartas de consciência raras/únicas | Compra unitária |
| **Mentorias guiadas** | Sessões de mentoria IA aprofundada | Assinatura |
| **Personalização** | Descrições elaboradas do personagem | Compra unitária |
| **Boosters sociais** | Destaque no banco de trocas | Temporário |

> **Cuidado**: Nunca vender vantagem competitiva — apenas estética e conveniência.
...
- Taxa de inscrição em eventos especiais
- Festivais narrativos presenciais
- Workshops de autoconhecimento guiados
...
## Formas de Expandir Potencialidades

### Dentro do Jogo
1. **Novos tipos de sala** (workshops, ateliês, clínicas)
2. **Novas mecânicas** (competições amigáveis, torneios de criatividade)
3. **IA cada vez mais sofisticada** (memória longa, personalidade)
4. **Crossover entre cidades** (missões inter-cidades)
...
2. **Spotify** — Playlists geradas pelas salas
3. **Google Maps** — Layer com locais do jogo
4. **Eventbrite** — Eventos do jogo integrados
...
|-------|---------|-----------|
| Custo de IA alto | Queima de caixa | Rate limiting, cache de respostas, LLM local |
| Poucos jogadores | Salas vazias | Começar micro, IA pode "preencher" |
| Bares não querem | Sem receita B2B | Provar valor grátis primeiro |
| Abuso/assédio | Destruir safe space | Moderação IA + denúncia + ban |
| WhatsApp mudar API | Quebrar tudo | Abstrair camada de comunicação |
