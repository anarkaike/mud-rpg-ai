...
| 7 | **QR Codes físicos** | Ponte real↔virtual que fortalece economia local |
...
GRÁTIS para jogar
    ↓
Bares pagam por visibilidade contextualizada (B2B)
    +
Jogadores podem acessar experiências premium (B2C)
    +
Eventos e festivais narrativos (B2C/B2B)
```
